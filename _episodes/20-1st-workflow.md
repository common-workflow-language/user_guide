...
~~~
{% include cwl/20-1st-workflow/1st-workflow.cwl %}
~~~
{: .source}

> ## Visualization of 1st-workflow.cwl
> <a href="https://view.commonwl.org/workflows/github.com/common-workflow-language/user_guide/blob/gh-pages/_includes/cwl/20-1st-workflow/1st-workflow.cwl"><img src="https://view.commonwl.org/graph/svg/github.com/common-workflow-language/user_guide/blob/gh-pages/_includes/cwl/20-1st-workflow/1st-workflow.cwl" alt="Visualization of 1st-workflow.cwl" /></a>
{: .callout}
...
~~~
{% include cwl/20-1st-workflow/1st-workflow-job.yml %}
~~~
{: .source}
