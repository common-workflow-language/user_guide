...
Tools and workflows can take [`File`](http://w3id.org/cwl/CommandLineTool.html#File) types as input and produce them as output.
We also recommend indicating the format for [`File`](http://w3id.org/cwl/CommandLineTool.html#File) types. This helps document
